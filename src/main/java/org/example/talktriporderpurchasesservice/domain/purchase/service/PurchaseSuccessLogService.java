package org.example.talktriporderpurchasesservice.domain.purchase.service;
...
import org.example.talktriporderpurchasesservice.domain.purchase.repository.PurchaseSuccessLogRepository;
...
@Service
public class PurchaseSuccessLogService {

    private final PurchaseSuccessLogRepository repository;
    private final ObjectMapper objectMapper;

    public PurchaseSuccessLogService(
            PurchaseSuccessLogRepository repository,
    ...
    public void saveFromPayload(
        ...
        PurchaseSuccessLog row = PurchaseSuccessLog.builder()
                .createdAt(createdAt)
                .orderId(longValue(payload, "orderId"))
                .orderCode(str(payload, "orderCode"))
                .memberEmail(str(payload, "memberEmail"))
                .totalAmount(intValue(payload, "totalAmount"))
                .paymentKey(str(payload, "paymentKey"))
                .paymentMethod(str(payload, "method"))
                .paymentStatus(str(payload, "status"))
                .payloadJson(json)
                .kafkaTopic(topic)
